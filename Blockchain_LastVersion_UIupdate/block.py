...
blockchain_dir = "Blockchain_LastVersion_UIupdate/blockchain/"
        ...
        def search():
            ...
            if ((bno=="all")or(bno=="All")or(bno=="ALL")):
                ...
                for i in range(1,blocks_count+1):
                    data_block = {}
                    with open(f"Blockchain_LastVersion_UIupdate/blockchain/{i}",'r')as f: 
                        content = f.read()
                ...
                data_block = {}
                with open(f"Blockchain_LastVersion_UIupdate/blockchain/{bno}",'r')as f: 
                    content = f.read()

...
def main_screen():
    ...
    def searchBlock():
        ...
        def search():
            bno = block_no.get()
            with open(f"Blockchain_LastVersion/blockchain/{bno}",'rb')as f: 
                content = f.read()
    ...
    def checkBlock():
        ...
        Button(mainframe,text="Check Integrity Now!!!",height="2",width=23,bg="#4CCE2E",fg="black",bd=0,command=check).place(x=300,y=20)
    ...
    Label(mainframe,text="1. B6201982 Thanakorn Sukhun",font=("arial",15),bg="#d7dae2").place(x=10,y=70)
